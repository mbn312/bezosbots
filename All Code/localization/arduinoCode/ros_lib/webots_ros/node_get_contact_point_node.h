#ifndef _ROS_SERVICE_node_get_contact_point_node_h
#define _ROS_SERVICE_node_get_contact_point_node_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char NODE_GET_CONTACT_POINT_NODE[] = "webots_ros/node_get_contact_point_node";

  class node_get_contact_point_nodeRequest : public ros::Msg
  {
    public:
    ...
    node_get_contact_point_nodeRequest():
      node(0),
      index(0)
    {
    }
    ...
    virtual const char * getType() override { return NODE_GET_CONTACT_POINT_NODE; };
    virtual const char * getMD5() override { return "07ddeeacce4a5bd7cac06cacca61cf88"; };

  };

  class node_get_contact_point_nodeResponse : public ros::Msg
  {
    public:
      typedef uint64_t _node_type;
      _node_type node;

    node_get_contact_point_nodeResponse():
      node(0)
    {
    }
  ...
  class node_get_contact_point_node {
    public:
